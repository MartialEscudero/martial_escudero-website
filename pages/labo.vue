...
<template>
    <div class="flex flex-col h-screen justify-center items-center text-center md:text-5xl text-2xl">
        ...
        <a rel="noopener" target="_blank" href="https://link.martialescudero.com" class="text-speed-up text-2">
            Social Media Sharing Link
        </a>
        <NuxtLink rel="noopener" target="_blank" to="/contact" class="text-speed-down text-3">
            Contact Form Single
        </NuxtLink>
        <NuxtLink rel="noopener" target="_blank" to="/labo/hexaclock.html" class="text-speed-up text-4">
            HexaClock
        </NuxtLink>
        <NuxtLink rel="noopener" target="_blank" to="/labo/color-palette-selector.html" class="text-speed-down text-5">
