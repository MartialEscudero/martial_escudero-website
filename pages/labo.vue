  ...
  <div class="flex h-screen">
    <div class="m-auto text-md xl:mx-auto">
      <div id="labo">
        ...
        <p class="text-center elementlabo" data-aos="fade-up">
          <NuxtLink rel="noopener" target="_blank" to="/contact" class="effect labotext5 xl:text-6xl sm:text-4xl">
            Contact Form Single
          </NuxtLink>
        </p>       
        <p class="text-center elementlabo" data-aos="fade-up">
          <NuxtLink rel="noopener" target="_blank" to="labo/meteo.html" class="effect labotext4 xl:text-6xl sm:text-4xl">
            API Météo
          </NuxtLink>
        </p>
        <p class="text-center elementlabo" data-aos="fade-up">
          <NuxtLink rel="noopener" target="_blank" to="labo/hexaclock.html" class="effect labotext3 xl:text-6xl sm:text-4xl">
            HexaClock
          </NuxtLink>
        </p>
        <p class="text-center elementlabo" data-aos="fade-up">
          <NuxtLink rel="noopener" target="_blank" to="labo/color-palette-selector.html" class="effect labotext2 xl:text-6xl sm:text-4xl">
            Color Palette Selector
          </NuxtLink>
        </p>
        <p class="text-center elementlabo" data-aos="fade-up">
          <NuxtLink rel="noopener" target="_blank" to="labo/concept-devis.html" class="effect labotext xl:text-6xl sm:text-4xl">
            Concept Devis
          </NuxtLink>
        </p>
      </div>
