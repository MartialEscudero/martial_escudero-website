...
<template>
    <div class="container px-5 mx-auto pt-10">
        ...
        <div v-if="!pending" class="grid grid-cols-1 md:grid-cols-2 mt-20 mb-10 lg:my-20 gap-16 md:gap-16 xl:gap-y-28 xl:gap-x-40">
            <a 
                v-for="project in setProjects(projects.data)"
