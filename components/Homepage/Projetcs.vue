...
<template>
    <div class="container px-5 mx-auto pt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mt-20 mb-10 lg:my-20 gap-16 md:gap-16 xl:gap-y-28 xl:gap-x-40">
            <NuxtLink v-for="project in projects" :to="project._path" class="h-[300px] md:h-[250px] lg:h-[350px] xl:h-[500px] w-full hover:scale-[1.05] transition ease-in-out duration-200">
