<template>
    <div
        id="about"
        class="container mx-auto px-5 pt-10"
    >
        <h2 class="text-center text-5xl sm:text-left">À Propos</h2>
