            ...
            <div class="space-y-16">
                ...
                <div class="flex justify-center gap-10 sm:justify-start">
                    <a href="https://www.linkedin.com/in/martial-escudero/" rel="noopener" target="_blank">
                        <svg class="h-10 w-10 fill-white transition duration-200 ease-in-out hover:fill-blue-300" viewBox="0 0 23.273 23.273">
                    ...
                    <a href="https://github.com/MartialEscudero" rel="noopener" target="_blank">
                        <svg class="h-10 w-10 fill-white transition duration-200 ease-in-out hover:fill-blue-300" viewBox="0 0 24 23">
                    ...
                    <a href="https://link.martialescudero.com/" rel="noopener" target="_blank">
                        <svg class="h-10 w-10 fill-white transition duration-200 ease-in-out hover:fill-blue-300" viewBox="0 0 24 24">
